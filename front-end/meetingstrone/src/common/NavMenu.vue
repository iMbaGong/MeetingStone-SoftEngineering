<template>
    ...
    >
        ...
        <el-menu-item v-if=isAdmin style="float: right" index="/AdminIndex">
            管理员页面
        </el-menu-item>
        <span style="float: right;margin: 20px 5px 10px;font-size: 13px;">
...
<script>
    export default {
        ...
        computed: {
            isAdmin: function () {
                let flag = false;
                let roles = this.$store.state.user.roles.split(',');
