            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-tag
                            ...
                            disable-transitions>{{applyType(scope.row.type)}}</el-tag>
                </template>
            </el-table-column>
            <el-table-column
            ...
            <el-table-column align="right">
                ...
                <template slot-scope="scope">
                    <el-button
                            size="mini"
                            :type="tagType(scope.row.type)"
                            @click="handleOperate(scope.$index, scope.row)">{{opType(scope.row.type)}}</el-button>
                </template>
            </el-table-column>
        </el-table>
                ...
                <el-form-item label="选择小组" :label-width="formLabelWidth" v-show="formType(applySelected.type)" prop="groupSelected">
                    <el-select v-model="form.groupSelected" placeholder="选择已加入的小组" style="width: 100%">
                        <el-option
                            ...
                            <span style="float: right; color: #8492a6; font-size: 13px">{{ item.leader.username }}</span>
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="备注" :label-width="formLabelWidth">
                    <el-input type="textarea" v-model="form.remark" maxlength="64" show-word-limit style="width: 100%"></el-input>
                </el-form-item>
            </el-form>
