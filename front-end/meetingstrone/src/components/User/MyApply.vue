        ...
        <el-collapse v-model="activeName" accordion style="max-width: 800px">
            <el-collapse-item v-for="(apply,index) in myApplies" :name="apply.id" :key="apply.id">
                ...
                <el-button type="danger" icon="el-icon-delete" circle style="float: right;margin:0 10px 15px 0"
                           @click="withdraw(index,apply.id)"></el-button>
                <el-badge :value="apply.unhandled" v-if="apply.unhandled>0" class="item"
                          style="float: right; margin: 7px 25px 0 0 ">
                ...
                <el-table-column label="操作" align="right">
                    <template slot-scope="scope">
                        <el-button
                            size="mini"
                            type="success"
                            @click="handlePass(scope.$index, scope.row)">接受
                        </el-button>
                        <el-button
                            size="mini"
                            type="danger"
